...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("vim_normal", "Vim normal", "join_line", "Join the current line with the next line."),
    ...
    action("vim_normal", "Vim normal", "move_big_word_forward", "Move to the start of the next big word."),
    action("vim_normal", "Vim normal", "move_big_word_backward", "Move to the start of the previous big word."),
    action("vim_normal", "Vim normal", "move_big_word_end", "Move to the end of the current or next big word."),
    ...
    action("vim_normal", "Vim normal", "delete_char_backward", "Delete the character before the cursor."),
    ...
    action("vim_normal", "Vim normal", "enter_replace", "Enter replace mode."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("vim_normal", "join_line") => Some(&mut keymap.vim_normal.join_line),
        ...
        ("vim_normal", "delete_char_backward") => Some(&mut keymap.vim_normal.delete_char_backward),
        ...
        ("vim_normal", "enter_replace") => Some(&mut keymap.vim_normal.enter_replace),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("vim_normal", "join_line") => Some(runtime_keymap.vim_normal.join_line.as_slice()),
        ...
        ("vim_normal", "move_big_word_forward") => Some(runtime_keymap.vim_normal.move_big_word_forward.as_slice()),
        ("vim_normal", "move_big_word_backward") => Some(runtime_keymap.vim_normal.move_big_word_backward.as_slice()),
        ("vim_normal", "move_big_word_end") => Some(runtime_keymap.vim_normal.move_big_word_end.as_slice()),
        ...
        ("vim_normal", "delete_char_backward") => Some(runtime_keymap.vim_normal.delete_char_backward.as_slice()),
        ("vim_normal", "substitute_char") => Some(runtime_keymap.vim_normal.substitute_char.as_slice()),
        ("vim_normal", "replace_char") => Some(runtime_keymap.vim_normal.replace_char.as_slice()),
        ("vim_normal", "enter_replace") => Some(runtime_keymap.vim_normal.enter_replace.as_slice()),
        ...
        ("vim_operator", "motion_big_word_forward") => Some(runtime_keymap.vim_operator.motion_big_word_forward.as_slice()),
        ("vim_operator", "motion_big_word_backward") => Some(runtime_keymap.vim_operator.motion_big_word_backward.as_slice()),
        ("vim_operator", "motion_big_word_end") => Some(runtime_keymap.vim_operator.motion_big_word_end.as_slice()),
